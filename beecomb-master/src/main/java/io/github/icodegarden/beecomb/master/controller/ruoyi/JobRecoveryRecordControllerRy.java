...
public class JobRecoveryRecordControllerRy extends BaseControllerRy {
	...
	public String jobRecoveryRecordList(ServerWebExchange exchange, ConcurrentModel mmap, @RequestParam(required = false) Long jobId) {
		mmap.put("jobId", jobId);
		return "job/jobRecoveryRecord/list";
	}

	@PostMapping("api/jobRecoveryRecord/list")
	public ResponseEntity<TableDataInfo> pageJobRecoveryRecords(ServerWebExchange exchange
